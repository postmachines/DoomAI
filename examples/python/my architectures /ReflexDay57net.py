...
params = pickle.load(open('../../examples/python/weightsdumps/weightsDay57DDM4.dump', "r"))
...
#---------------------------------------------------------------------testing steps-----------------------------------------------------------------------
    ...
    pickle.dump(get_all_param_values(net), open('../../examples/python/weightsdumps/weightsDay57DDM5.dump', "w"))
...
params = pickle.load(open('../../examples/python/weightsdumps/weightsDay57DDM5.dump', "r"))
set_all_param_values(net, params)
