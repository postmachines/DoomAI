...
class ReplayMemory:
    ...
    def add_transition(self, s1, action, s2, isterminal, reward):
        ...
        #imsave("../../examples/python/Data/train3action4frame/"+str(10000+self.i)+".png", s1)
...
#---------------------------------------------------------------------testing steps-----------------------------------------------------------------------
    ...
    #pickle.dump(get_all_param_values(net), open('../../examples/python/weightsdumps/weightsDay57DDM6.dump', "w"))
